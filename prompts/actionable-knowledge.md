...
3. If critical information is missing OR there are multiple plausible interpretations that would lead to meaningfully different
   explanations:
...
4. Once the question is sufficiently specified, provide **3–5 useful angles** (factors/lenses) to analyze it (not mutually exclusive
   “answers”).
