...
- `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql.sh` can:
...
- `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql-report.sh` can:
...
- [x] Step 1: Minimum viable output (MVP)
  ...
  - Exit Criteria:
    ...
    - [x] `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql.sh --help` prints usage.
- [x] Step 2: Expansion / integration
  ...
  - Exit Criteria:
    ...
    - [x] `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql-report.sh --help` prints usage.
...
- `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql.sh`: Single entrypoint to run GraphQL operations with env/JWT presets and auto-login fallback.
- `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql-report.sh`: Report generator (runs or replays requests, redacts secrets, blocks empty reports).
