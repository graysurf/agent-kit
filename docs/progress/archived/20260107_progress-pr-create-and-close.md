...
- [x] Step 1: Minimum viable output (MVP)
  ...
  - Artifacts:
    ...
    - `$AGENT_HOME/skills/workflows/pr/progress/create-progress-pr/scripts/create_progress_file.sh`
    - `$AGENT_HOME/skills/workflows/pr/progress/create-progress-pr/scripts/render_progress_pr.sh`
  - Exit Criteria:
    - [x] `bash -n skills/workflows/pr/progress/create-progress-pr/scripts/*.sh` passes.
    - [x] Create a progress file in this repo: `$AGENT_HOME/skills/workflows/pr/progress/create-progress-pr/scripts/create_progress_file.sh --title "X"`.
...
- [x] Step 2: Expansion / integration
  ...
  - Artifacts:
    ...
    - `$AGENT_HOME/skills/workflows/pr/progress/close-progress-pr/scripts/close_progress_pr.sh`
    - `skills/workflows/pr/feature/close-feature-pr/SKILL.md`
    - `$AGENT_HOME/skills/workflows/pr/feature/close-feature-pr/scripts/close_feature_pr.sh`
    ...
    - `README.md`
  - Exit Criteria:
    - [x] `bash -n $AGENT_HOME/skills/workflows/pr/progress/close-progress-pr/scripts/close_progress_pr.sh` passes.
