...
- Add `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`:
...
- [x] Step 1: Minimum viable output (MVP)
  - Work Items:
    - [x] Implement `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`
  - Artifacts:
    - `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`
  - Exit Criteria:
...
- [x] Step 3: Validation / testing
  ...
  - Exit Criteria:
    - [x] Commands executed with results recorded:
      - `cp -R "$AGENT_HOME/skills/tools/testing/api-test-runner/assets/scaffold/setup" ./setup`
      - `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh --suite smoke-demo --out out/api-test-runner/results.json`
      - `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh --in out/api-test-runner/results.json --out out/api-test-runner/summary.md --slow 5`
...
- `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`: turns results JSON into a small Markdown summary for CI + PMs.
