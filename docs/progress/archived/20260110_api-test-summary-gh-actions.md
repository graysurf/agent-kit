# agent-kit: API test runner: CI summary report (GitHub Actions)
...
- PR: https://github.com/graysurf/agent-kit/pull/15
...
- Add `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`:
...
- [x] Step 1: Minimum viable output (MVP)
  - Work Items:
    - [x] Implement `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`
  - Artifacts:
    - `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`
  - Exit Criteria:
...
- [x] Step 3: Validation / testing
  ...
  - Exit Criteria:
    - [x] Commands executed with results recorded:
      - `cp -R "$AGENTS_HOME/skills/tools/testing/api-test-runner/assets/scaffold/setup" ./setup`
      - `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh --suite smoke-demo --out out/api-test-runner/results.json`
      - `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh --in out/api-test-runner/results.json --out out/api-test-runner/summary.md --slow 5`
...
- `$AGENTS_HOME/skills/tools/testing/api-test-runner/scripts/api-test-summary.sh`: turns results JSON into a small Markdown summary for CI + PMs.
