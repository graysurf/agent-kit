...
- `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh` can:
...
- Naming conventions (finalized):
  ...
  - `setup/rest/tokens.env` (placeholders only; real tokens go in `setup/rest/tokens.local.env`):
    ...
    - `REST_TOKEN_ADMIN=`
    - `REST_TOKEN_MEMBER=`
- `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-report.sh` can:
...
- [x] Step 0: Alignment / prerequisites
  ...
  - Exit Criteria:
    ...
    - [x] Minimal reproducible verification commands are defined (to execute in Step 3):
      - `REST_URL=<baseUrl> ACCESS_TOKEN=<token> $AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh --url "$REST_URL" setup/rest/requests/health.request.json`
- [x] Step 1: Minimum viable output (MVP)
  - Work Items:
    - [x] Implement `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh` (endpoint + auth presets, execute request, history).
    - [x] Implement `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-history.sh` (replay last command; tail N).
    - [x] Implement `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-report.sh` (generate Markdown report with redaction).
  ...
  - Artifacts:
    - `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh`
    - `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-history.sh`
    - `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-report.sh`
    - `skills/tools/testing/rest-api-testing/assets/scaffold/setup/rest/*`
    - `skills/tools/testing/rest-api-testing/SKILL.md`
    - `skills/tools/testing/rest-api-testing/references/REST_API_TEST_REPORT_CONTRACT.md`
  - Exit Criteria:
...
- `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh`: Single entrypoint to run REST requests with env/token presets and history.
- `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-report.sh`: Report generator (runs or replays requests, redacts secrets by default).
- `$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest-history.sh`: History reader / replay helper.
