...
- A new runner script exists (proposed: `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh`) that can run a suite manifest and exits non-zero when any case fails.
  ...
  "cases": [
    {
      ...
      "status": "passed",
      "durationMs": 120,
      "command": "$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh --config-dir setup/rest --env staging setup/rest/requests/health.request.json"
    },
    {
      "id": "graphql.countries",
      "type": "graphql",
      "status": "passed",
      "durationMs": 240,
      "command": "$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql.sh --config-dir setup/graphql --env staging --jwt ci setup/graphql/operations/countries.graphql setup/graphql/operations/countries.variables.json | jq -e '...'",
      "assertions": {
...
- Reuse existing stable callers (`$AGENT_HOME/skills/tools/testing/rest-api-testing/scripts/rest.sh`, `$AGENT_HOME/skills/tools/testing/graphql-api-testing/scripts/gql.sh`) instead of re-implementing HTTP/auth logic.
...
- [x] Step 1: Minimum viable output (MVP)
  ...
  - Artifacts:
    ...
    - `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh`
...
$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh --suite smoke-demo --only rest.httpbin.get
...
- `$AGENT_HOME/skills/tools/testing/api-test-runner/scripts/api-test.sh`: Suite runner that executes REST/GraphQL cases and produces JSON results.
