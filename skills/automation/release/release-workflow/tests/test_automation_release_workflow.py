...
def test_automation_release_workflow_declares_retained_entrypoints() -> None:
    ...
    assert "$AGENT_HOME/skills/automation/release/release-workflow/scripts/release-resolve.sh" in text
    assert "$AGENT_HOME/skills/automation/release/release-workflow/scripts/release-publish-from-changelog.sh" in text
