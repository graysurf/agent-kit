...
- `$AGENT_HOME/skills/tools/review/open-changed-files-review/scripts/open-changed-files.zsh` available.
...
3. Prefer running:
   - `$AGENT_HOME/skills/tools/review/open-changed-files-review/scripts/open-changed-files.zsh --max-files "$max" --workspace-mode pwd -- <files...>`
...
```zsh
$AGENT_HOME/skills/tools/review/open-changed-files-review/scripts/open-changed-files.zsh --max-files "${CODEX_OPEN_CHANGED_FILES_MAX_FILES:-50}" --workspace-mode pwd -- <files...>
```
