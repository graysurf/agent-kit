...
This directory contains portable agent skills tracked by this repo. A "skill" is a self-contained set of runnable instructions plus any
scripts, helpers, tests, and references needed to keep it reliable.
