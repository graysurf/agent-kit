...
| MR / GitLab | [deliver-gitlab-mr](./skills/workflows/mr/gitlab/deliver-gitlab-mr/)                                 | Deliver GitLab merge requests end to end with preflight, creation, pipeline wait, merge, and cleanup                    |
| PR / Delivery | [deliver-pr](./skills/workflows/pr/deliver-pr/)                                                   | Deliver bug or feature PRs end to end with `kind=bug|feature`, CI wait/fix loop, and close/merge gates                                    |
