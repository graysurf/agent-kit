...
| Reporting    | [daily-brief](./skills/workflows/reporting/daily-brief/)                                            | Prepare a source-grounded daily information brief by orchestrating topic-radar JSON with stable preferences and concise user-language synthesis |
