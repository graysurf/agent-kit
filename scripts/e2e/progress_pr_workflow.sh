...
Examples:
  E2E_ALLOW_REAL_GH=1 scripts/e2e/progress_pr_workflow.sh --phase all
  E2E_ALLOW_REAL_GH=1 scripts/e2e/progress_pr_workflow.sh --phase cleanup --run-id 20260124-120000-abc123
USAGE
}
